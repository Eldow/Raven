...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG161169 DB	'RailGun_MaxRoundsCarried', 00H
	ORG $+3
_pi	DQ	0400921f9f01b866er		; 3.14159
$SG161171 DB	'RocketLauncher_MaxRoundsCarried', 00H
$SG161173 DB	'ShotGun_MaxRoundsCarried', 00H
	ORG $+3
$SG161177 DB	'trying to calculate  of unknown weapon', 00H
CONST	ENDS
