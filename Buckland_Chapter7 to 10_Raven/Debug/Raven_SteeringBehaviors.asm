...
_pi	DQ	0400921f9f01b866er		; 3.14159
$SG151861 DB	'WallDetectionFeelerLength', 00H
	ORG $+2
$SG151862 DB	'SeparationWeight', 00H
	ORG $+3
$SG151863 DB	'WanderWeight', 00H
	ORG $+3
$SG151864 DB	'WallAvoidanceWeight', 00H
$SG151865 DB	'SeekWeight', 00H
	ORG $+1
$SG151866 DB	'ArriveWeight', 00H
	ORG $+3
$SG151867 DB	'ViewDistance', 00H
	ORG $+3
_colors	DD	0ffH
	DD	0ff0000H
	DD	0ff00H
