; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30501.0 
	...
	TITLE	D:\franc\Documents\IA - Mini-projet\RavenRepo\Buckland_Chapter7 to 10_Raven\Raven_SteeringBehaviors.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_pi	DQ	0400921f9f01b866er		; 3.14159
$SG151878 DB	'WallDetectionFeelerLength', 00H
	ORG $+2
$SG151879 DB	'SeparationWeight', 00H
	ORG $+3
$SG151880 DB	'WanderWeight', 00H
	ORG $+3
$SG151881 DB	'WallAvoidanceWeight', 00H
$SG151882 DB	'SeekWeight', 00H
	ORG $+1
$SG151883 DB	'ArriveWeight', 00H
	ORG $+3
$SG151884 DB	'ViewDistance', 00H
	ORG $+3
_colors	DD	0ffH
	DD	0ff0000H
	DD	0ff00H
...
; Function compile flags: /Odtp /RTCsu
; File d:\franc\documents\ia - mini-projet\ravenrepo\common\game\entityfunctiontemplates.h
...
; 175  :               {TagNeighbors(pRaven_Bot, m_Bots, range);}  
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\franc\documents\ia - mini-projet\ravenrepo\buckland_chapter7 to 10_raven\raven_steeringbehaviors.cpp
_TEXT	SEGMENT
$T1 = -20						; size = 16
_this$ = -4						; size = 4
...
; 47   : {
	...
	push	OFFSET $SG151879
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	edx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [edx+120]
	push	OFFSET $SG151880
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	eax, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [eax+128]
	push	OFFSET $SG151881
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	ecx, DWORD PTR _this$[ebp]
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\franc\documents\ia - mini-projet\ravenrepo\buckland_chapter7 to 10_raven\raven_steeringbehaviors.h
...
; 105  : inline double RandomClamped()    {return RandFloat() - RandFloat();}
